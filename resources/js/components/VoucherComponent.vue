...
export default {
    ...
    data() {
        return {
            columns: ['survey_stub', 'voucher_code', 'created_at'],
            voucher_table_data: [],
            options: {
                headings: {
                    survey_stub: 'Survey Stub',
                    voucher_code: 'Voucher Code',
                    created_at: 'Claimed Date',
                    action: 'Action',
                },
                sortable: ['survey_stub', 'voucher_code', 'created_at'],
                filterable: ['survey_stub', 'voucher_code', 'created_at'],
                 templates: {
    ...
    methods: {
        ...
        initialData() {
            this.voucher_table_data = [];
            axios.get('voucher/getdata').then(response => {
                this.voucher_table_data = response.data.vouchers;
            })
        },
