...
<header>
    <table class="table-header" width="100%;">
        <tr>
            <th width="75%" class="company">Dumaguete Survey</th>
            <th>User ID: <span class="username">{{ Auth::user()->name }}</span></th>
        </tr>
        <tr>
            <th class="city">Dumaguete City</th>
            <th class="page-number">Page No: <span class="pagenum"></span></th>
        </tr>
        <tr>
            <th class="report-title">Survey for Additional Fee</th>
